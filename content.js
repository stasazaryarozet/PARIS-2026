const CONTENT = {
  hero: {
    ...
    subtitle: "Фактуры, материалы, атмосфера. <br><span class=\"emphasis\">Можно ли&nbsp;ощутить словами?</span><br> <br><span class=\"emphasis\">4 ДНЯ</span><br>с Ольгой Розет и&nbsp;Натальей Логиновой",
