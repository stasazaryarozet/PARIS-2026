...
**Принцип:** Все исходники в одной директории **плоско**, с информативными именами по формату: `YYYY-MM[-DD]_источник_тип_описание.расширение`

```
source_materials/ (74 файла)
├── Аудиозаписи Ольги (7 .m4a)
├── Транскрипты Ольги (7 .txt)
├── Видео бота — отзывы сентябрь 2025 (8 .mp4)
├── Транскрипты бота — сентябрь (8 .txt)
├── Метаданные бота — сентябрь (9 .json)
├── Видео бота — форварды ноябрь 2025 (4 .mp4)
├── Фото бота — ноябрь (1 .jpg)
├── Текст бота — ноябрь (5 .txt)
├── Скриншоты предыдущего лендинга (12 .png)
├── Промпты для AI-визуализации (3 .txt)
├── Черновики IG-постов (2 .txt)
...
## 📹 ВИДЕО-ОТЗЫВЫ УЧАСТНИКОВ (TELEGRAM BOT CATCH)

### Источник: Telegram-группа "N, O, S" + Личные сообщения
### Период: Сентябрь–Ноябрь 2025
### Архиватор: Telegram Bot (автоматический сбор)

---

### СЕНТЯБРЬ 2025: Отзывы участников программы Paris September

#### Видео-отзывы (8 файлов)

| № | Файл | Длительность | Участник | Дата записи | Ключевые темы |
|---|------|--------------|----------|-------------|---------------|
| 1 | `2025-09_bot_video_review_natalia_manual_20251029_182058.mp4` | 18:16 | Наталья Логинова | 29.10.2025 | Благодарность участников, "кульминация каждый день", методическое построение программы, важность малой группы |
| 2 | `2025-09_bot_video_review_video_4_20251029_181656.mp4` | - | Участница | 29.10.2025 | Отзыв группы |
| 3 | `2025-09_bot_video_review_video_5_20251029_181657.mp4` | - | Участница | 29.10.2025 | Отзыв группы |
| 4 | `2025-09_bot_video_review_video_6_20251029_181658.mp4` | - | Участница | 29.10.2025 | Отзыв группы |
| 5 | `2025-09_bot_video_review_video_7_20251029_181700.mp4` | - | Участница | 29.10.2025 | Отзыв группы |
| 6 | `2025-09_bot_video_review_video_8_20251029_181701.mp4` | - | Участница | 29.10.2025 | Отзыв группы |
| 7 | `2025-09_bot_video_review_video_9_20251029_181703.mp4` | - | Участница | 29.10.2025 | Отзыв группы |
| 8 | `2025-09_bot_video_review_video_10_20251029_181704.mp4` | - | Участница | 29.10.2025 | Отзыв группы, эмоции |

#### Ключевые инсайты из транскрипта главного видео-отзыва (Наталья):

**Цитаты участников:**

> "Для меня это одно из самых крутейших путешествий какое только было в моей жизни"

> "Путешествие как мне кажется удалось, мы много что узнали, будем еще долгое время переваривать"

> "Тут сразу была кульминация первый день, кульминация второй день, опять кульминация третий день"

> "Методически совершенно: если бы мы пришли к скульптурам в первый день, я бы так не прочувствовала. Дойти до скульптур — до высшей сложности в понимании"

> "Невероятно важна компания. Небольшие компании — это часть путешествия. Теплое комьюнити, где каждый друг друга запоминает"

> "Париж — это любовь на всю жизнь"

**Успешные элементы программы (валидация для January 2026):**

1. **Построение программы от простого к сложному** — методически продуманная последовательность
2. **Каждый день = кульминация** — высокая интенсивность, без "провисаний"
3. **Малая группа (12 человек)** — ключевой фактор атмосферы
4. **Тандем кураторов** — Ольга + Наталья создают синергию
5. **Эмоциональная вовлечённость** — не только знания, но и переживания
6. **Долгий эффект** — участники "будут переваривать" материал месяцами

---

### НОЯБРЬ 2025: Форвардненные материалы

#### Видео (4 файла)

| № | Файл | Дата | Содержание (предположительно) |
|---|------|------|-------------------------------|
| 1 | `2025-11-01_bot_video_video_48_20251101_051956.mp4` | 01.11.2025 | Форвардненное видео |
| 2 | `2025-11-01_bot_video_video_49_20251101_052032.mp4` | 01.11.2025 | Форвардненное видео |
| 3 | `2025-11-01_bot_video_video_66_20251101_053028.mp4` | 01.11.2025 | Форвардненное видео |
| 4 | `2025-11-01_bot_video_video_67_20251101_053104.mp4` | 01.11.2025 | Форвардненное видео |

#### Фотографии (1 файл)

| № | Файл | Дата | Содержание (предположительно) |
|---|------|------|-------------------------------|
| 1 | `2025-11-01_bot_photo_photo_65_20251101_053018.jpg` | 01.11.2025 | Архитектурное фото |

#### Текстовые сообщения (5 файлов)

| № | Файл | Дата | Содержание (предположительно) |
|---|------|------|-------------------------------|
| 1 | `2025-11-01_bot_text_text_62_20251101_052951.txt` | 01.11.2025 | Текстовое сообщение |
| 2 | `2025-11-01_bot_text_text_62_20251101_053002.txt` | 01.11.2025 | Текстовое сообщение |
| 3 | `2025-11-01_bot_text_text_63_20251101_052957.txt` | 01.11.2025 | Текстовое сообщение |
| 4 | `2025-11-01_bot_text_text_63_20251101_053007.txt` | 01.11.2025 | Текстовое сообщение |
| 5 | `2025-11-01_bot_text_text_64_20251101_053013.txt` | 01.11.2025 | Текстовое сообщение |

**Примечание:** Эти материалы требуют дальнейшей обработки:
- Транскрипция видео (Whisper)
...
### Скриншоты предыдущего лендинга (16 октября 2025)

**Количество:** 12 файлов  
**Назначение:** Референс предыдущей версии дизайна для сравнения и анализа

**Файлы:**
- `2025-10-16_previous_landing_screenshot_01.png` through `_11.png`
- `2025-10-16_landing_concept_screenshot.png` (отдельный концепт)

---

## ✍️ AI-ПРОМПТЫ И ЧЕРНОВИКИ

### Промпты для визуальной генерации

**Файлы:**
- `2025-10_visual_prompt_mirror_v1.txt` — первая версия промпта для зеркала
- `2025-10_visual_prompt_mirror_v2.txt` — вторая итерация
- `2025-10_visual_prompt_mirror_v3.txt` — финальная версия

**Назначение:** Промпты для генерации ключевого визуального образа (зеркало как метафора отражения ар-деко)

### Черновики контента для Instagram

**Файлы:**
- `2025-10_ig_post_draft.txt` — черновик поста для Instagram
- `2025-10_ig_stories_texts_draft.txt` — тексты для сториз
...
**Файл:** `2025-10_gemini_dialogue_history.txt`  
**Размер:** 6647 строк  
**Содержание:** Полная история переписки с Gemini по вопросам стратегии, визуала, контента

### Instagram аналитика

**Файл:** `2025-10-29_ig_insights_analytics.txt`  
**Дата:** 29 октября 2025  
**Содержание:** Аналитика охватов и вовлечённости для предыдущей кампании
...
**Файл:** `2025-10_olga_notes_shorthand_program.txt`  
**Размер:** 5 строк  
**Содержание:** Рукописные заметки Ольги — краткий конспект программы по дням

**Текст:**
```
15 января: Printemps → Nolinski → Legré → Музей
16 января: Левый берег → Galerie Vallois → Palais de Tokyo + Trocadéro
17 января: Maison & Objet
18 января: Вилла Аалто → Парк → Ужин
```
...
**Обновлено:** 1 ноября 2025 (добавлен улов Telegram Bot)  
